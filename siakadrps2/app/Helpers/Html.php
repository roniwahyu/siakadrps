			...
			<div class="modal-dialog modal-dialog-centered modal-sm">
				<div class="modal-content">
					<div class="modal-header">
						<h4 class="modal-title"><?php echo __('importData') ?></h4>
					...
					<div class="modal-body">
						<div class="custom-file" id="customFile" lang="<?php echo app()->getLocale(); ?>">
							...
							<label class="custom-file-label" for="inputfile">
								<?php echo __('selectAFileToImport') ?>
							</label>
						</div>
						<small class="text-muted"><?php echo __('supportedFileTypes') ?>(csv)</small>
					</div>
					<div class="modal-footer">
						<button type="reset" class="btn btn-secondary" data-bs-dismiss="modal"><?php echo __('close') ?></button>
						<button type="submit" class="btn btn-primary"><?php echo __('importData') ?></button>
					</div>
				</div>
			</div>
		</form>
