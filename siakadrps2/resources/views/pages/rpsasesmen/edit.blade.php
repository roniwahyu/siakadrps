...
<?php
    $pageTitle = __('editRpsAsesman'); //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">{{ __('editRpsAsesman') }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("rpsasesmen/edit/$rec_id"); ?>" method="post">
                        <!--[form-content-start]-->
                        @csrf
                        <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-asesmen-holder" class=" ">
                                            <input id="ctrl-asesmen" data-field="asesmen"  value="<?php  echo $data['asesmen']; ?>" type="text" placeholder="{{ __('enterAsesmen') }}"  name="asesmen"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
