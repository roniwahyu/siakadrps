...
<?php
    $pageTitle = __('addNewRpsCp'); //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">{{ __('addNewRpsCp') }}</div>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-kode_cp-holder" class=" ">
                                                <input id="ctrl-kode_cp" data-field="kode_cp"  value="<?php echo get_value('kode_cp') ?>" type="text" placeholder="{{ __('enterKodeCp') }}"  name="kode_cp"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-nama_cp-holder" class=" ">
                                                <textarea placeholder="{{ __('enterNamaCp') }}" id="ctrl-nama_cp" data-field="nama_cp"  rows="5" name="nama_cp" class=" form-control"><?php echo get_value('nama_cp') ?></textarea>
