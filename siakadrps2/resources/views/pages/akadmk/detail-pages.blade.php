    ...
    <div class="master-detail-page card">
        <div class="card-header text-bold h5 p-3 mb-3">Akad Mk Records</div>
        <div class="p-2">
    ...
    <div class="tab-content">
        ...
        <div class=" ">
            <?php
                $params = ['id_mk' => $rec_id,'show_header' => false]; //new query param
                $query = array_merge(request()->query(), $params);
                $queryParams = http_build_query($query);
                $url = url("rpscpmk/index/id_mk/$rec_id?$queryParams");
            ?>
