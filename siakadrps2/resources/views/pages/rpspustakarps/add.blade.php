...
<?php
    $pageTitle = __('addNewRpsPustakaRp'); //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">{{ __('addNewRpsPustakaRp') }}</div>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-no_urut-holder" class=" ">
                                                <input id="ctrl-no_urut" data-field="no_urut"  value="<?php echo get_value('no_urut') ?>" type="number" placeholder="{{ __('enterNoUrut') }}" step="any"  name="no_urut"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-pustaka-holder" class=" ">
                                                <textarea placeholder="{{ __('enterPustaka') }}" id="ctrl-pustaka" data-field="pustaka"  rows="5" name="pustaka" class=" form-control"><?php echo get_value('pustaka') ?></textarea>
