    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">{{ __('editAkadFakulta') }}</div>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-kode_fakultas-holder" class=" ">
                                            <input id="ctrl-kode_fakultas" data-field="kode_fakultas"  value="<?php  echo $data['kode_fakultas']; ?>" type="text" placeholder="{{ __('enterKodeFakultas') }}"  required="" name="kode_fakultas"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-nama_fakultas-holder" class=" ">
                                            <input id="ctrl-nama_fakultas" data-field="nama_fakultas"  value="<?php  echo $data['nama_fakultas']; ?>" type="text" placeholder="{{ __('enterNamaFakultas') }}"  required="" name="nama_fakultas"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
