...
<?php
    $pageTitle = __('addNewFakultas'); //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">{{ __('addNewAkadFakulta') }}</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row ">
                <div class="col-md-4 comp-grid " >
                        ...
                        <form id="akadfakultas-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('akadfakultas.store') }}" method="post">
                            ...
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="control-label" for="universitas_id">{{ __('universitasId') }} <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div id="ctrl-universitas_id-holder" class=" ">
                                                <select required=""  id="ctrl-universitas_id" data-field="universitas_id" name="universitas_id"  placeholder="{{ __('selectAValue') }}"    class="form-select" >
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="control-label" for="kode_fakultas">{{ __('kodeFakultas') }} <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div id="ctrl-kode_fakultas-holder" class=" ">
                                                <input id="ctrl-kode_fakultas" data-field="kode_fakultas"  value="<?php echo get_value('kode_fakultas') ?>" type="text" placeholder="{{ __('enterKodeFakultas') }}"  required="" name="kode_fakultas"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group ">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="control-label" for="nama_fakultas">{{ __('namaFakultas') }} <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div id="ctrl-nama_fakultas-holder" class=" ">
                                                <input id="ctrl-nama_fakultas" data-field="nama_fakultas"  value="<?php echo get_value('nama_fakultas') ?>" type="text" placeholder="{{ __('enterNamaFakultas') }}"  required="" name="nama_fakultas"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <a  class="btn " href="<?php print_link("akadfakultas") ?>" >
            ...
            <div class="col-md-8 comp-grid " >
                <div class=" ">
                    <?php
                        ...
                        $url = url("akadfakultas/index?$queryParams");
                    ?>
