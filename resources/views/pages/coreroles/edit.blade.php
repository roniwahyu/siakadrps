...
<?php
    $pageTitle = __('editCoreRole'); //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">{{ __('editCoreRole') }}</div>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div  class="card card-1 border rounded page-content" >
                        ...
                        <div>
                            <div class="form-group ">
                                <div class="row">
                                    <div class="col-sm-4">
                                        <label class="control-label" for="role_name">{{ __('roleName') }} </label>
                                    </div>
                                    <div class="col-sm-8">
                                        <div id="ctrl-role_name-holder" class=" ">
                                            <input id="ctrl-role_name" data-field="role_name"  value="<?php  echo $data['role_name']; ?>" type="text" placeholder="{{ __('enterRoleName') }}"  name="role_name"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
