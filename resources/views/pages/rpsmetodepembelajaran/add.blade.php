...
<?php
    $pageTitle = __('addNewRpsMetodePembelajaran'); //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">{{ __('addNewRpsMetodePembelajaran') }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form id="rpsmetodepembelajaran-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('rpsmetodepembelajaran.store') }}" method="post">
                            @csrf
                            <div>
                                <div class="form-group ">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="control-label" for="metode">{{ __('metode') }} </label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div id="ctrl-metode-holder" class=" ">
                                                <input id="ctrl-metode" data-field="metode"  value="<?php echo get_value('metode') ?>" type="text" placeholder="{{ __('enterMetode') }}"  name="metode"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
