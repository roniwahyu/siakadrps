...
<?php
    $pageTitle = __('editRpsPenilaianCpmk'); //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">{{ __('editRpsPenilaianCpmk') }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("rpspenilaiancpmk/edit/$rec_id"); ?>" method="post">
                        <!--[form-content-start]-->
                        @csrf
                        <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-id_subcpmk-holder" class=" ">
                                            <input id="ctrl-id_subcpmk" data-field="id_subcpmk"  value="<?php  echo $data['id_subcpmk']; ?>" type="number" placeholder="{{ __('enterIdSubcpmk') }}" step="any"  name="id_subcpmk"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-id_kriteria-holder" class=" ">
                                            <input id="ctrl-id_kriteria" data-field="id_kriteria"  value="<?php  echo $data['id_kriteria']; ?>" type="number" placeholder="{{ __('enterIdKriteria') }}" step="any"  name="id_kriteria"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-bobot_prosen-holder" class=" ">
                                            <input id="ctrl-bobot_prosen" data-field="bobot_prosen"  value="<?php  echo $data['bobot_prosen']; ?>" type="number" placeholder="{{ __('enterBobotProsen') }}" step="0.1"  name="bobot_prosen"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
