...
<?php
    ...
    $pageTitle = __('akadDosen'); //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container-fluid">
            <div class="row justify-content-between align-items-center gap-3">
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">{{ __('akadDosen') }}</div>
                    </div>
                </div>
                <div class="col-auto  " >
                    <?php if($can_add){ ?>
                            ...
                            <table class="table table-hover table-striped table-sm text-left">
                                <thead class="table-header ">
                                    <tr>
                                        ...
                                        <?php } ?>
                                        <th class="td-nidn" > {{ __('nidn') }}</th>
                                        <th class="td-id_prodi" > {{ __('idProdi') }}</th>
                                        <th class="td-nama_lengkap" > {{ __('namaLengkap') }}</th>
                                        <th class="td-nama_lengkap_gelar" > {{ __('namaLengkapGelar') }}</th>
                                ...
                                <tbody class="page-data">
                                    ...
                                    <tr>
                                        ...
                                        <td class="td-btn">
                                            ...
                                            <?php } ?>
                                            <?php if($can_delete){ ?>
                                            <a class="dropdown-item record-delete-btn" data-prompt-msg="{{ __('promptDeleteRecord') }}" data-display-style="modal" href="<?php print_link("akaddosen/delete/$rec_id"); ?>" >
            ...
            <div class=" mt-3">
                <div class="row align-items-center justify-content-between">    
                    <div class="col-md-auto d-flex">    
                        <?php if($can_delete){ ?>
                        <button data-prompt-msg="{{ __('promptDeleteRecords') }}" data-display-style="modal" data-url="<?php print_link("akaddosen/delete/{sel_ids}"); ?>" class="btn btn-sm btn-danger btn-delete-selected d-none">
