...
<?php
    ...
    $pageTitle = __('akadMk'); //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container-fluid">
            <div class="row justify-content-between align-items-center gap-3">
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">{{ __('akadMk') }}</div>
                    </div>
                </div>
                <div class="col-auto  " >
                            ...
                            <table class="table table-hover table-striped table-sm text-left">
                                <thead class="table-header ">
                                    <tr>
                                        ...
                                        <th class="td-kode_mk" > {{ __('kodeMk') }}</th>
                                        <th class="td-id_siakad_kurikulum" > {{ __('idSiakadKurikulum') }}</th>
                                        <th class="td-nm_mk" > {{ __('nmMk') }}</th>
                                        <th class="td-jns_mk" > {{ __('jnsMk') }}</th>
                                        <th class="td-kurikulum_mk" > {{ __('kurikulumMk') }}</th>
                                        <th class="td-kelompok_mk" > {{ __('kelompokMk') }}</th>
                                        <th class="td-sks_mk" > {{ __('sksMk') }}</th>
                                        <th class="td-sks_tatapmuka" > {{ __('sksTatapmuka') }}</th>
                                ...
                                <td class="td-btn">
                                    ...
                                    <a class="dropdown-item record-delete-btn" data-prompt-msg="{{ __('promptDeleteRecord') }}" data-display-style="modal" href="<?php print_link("akadmk/delete/$rec_id"); ?>" >
    ...
    <div class=" mt-3">
        <div class="row align-items-center justify-content-between">    
            <div class="col-md-auto d-flex">    
                <button data-prompt-msg="{{ __('promptDeleteRecords') }}" data-display-style="modal" data-url="<?php print_link("akadmk/delete/{sel_ids}"); ?>" class="btn btn-sm btn-danger btn-delete-selected d-none">
