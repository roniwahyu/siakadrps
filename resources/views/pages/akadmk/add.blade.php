                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-upload_silabus_mk-holder" class=" ">
                                                <input id="ctrl-upload_silabus_mk" data-field="upload_silabus_mk"  value="<?php echo get_value('upload_silabus_mk') ?>" type="text" placeholder="{{ __('enterUploadSilabusMk') }}"  name="upload_silabus_mk"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-upload_sap_mk-holder" class=" ">
                                                <input id="ctrl-upload_sap_mk" data-field="upload_sap_mk"  value="<?php echo get_value('upload_sap_mk') ?>" type="text" placeholder="{{ __('enterUploadSapMk') }}"  name="upload_sap_mk"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-upload_bahan_mk-holder" class=" ">
                                                <input id="ctrl-upload_bahan_mk" data-field="upload_bahan_mk"  value="<?php echo get_value('upload_bahan_mk') ?>" type="text" placeholder="{{ __('enterUploadBahanMk') }}"  name="upload_bahan_mk"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
