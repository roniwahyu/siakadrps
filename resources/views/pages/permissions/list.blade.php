                                ...
                                <tbody class="page-data">
                                    ...
                                    <tr>
                                        ...
                                        <td class="td-role_id">
                                            ...
                                            <i class="fa fa-eye"></i> <?php echo "Roles" ?>
                                        </a>
                                    </td>
                                    ...
                                    <td class="td-btn">
                                        ...
                                        <a class="dropdown-item record-delete-btn" data-prompt-msg="{{ __('promptDeleteRecord') }}" data-display-style="modal" href="<?php print_link("permissions/delete/$rec_id"); ?>" >
