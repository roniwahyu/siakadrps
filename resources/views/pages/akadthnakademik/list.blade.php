...
<?php
    ...
    $can_add = $user->canAccess("akadthnakademik/add");
    $can_edit = $user->canAccess("akadthnakademik/edit");
    $can_view = $user->canAccess("akadthnakademik/view");
    $can_delete = $user->canAccess("akadthnakademik/delete");
                            ...
                            <table class="table table-hover table-striped table-sm text-left">
                                <thead class="table-header ">
                                    <tr>
                                        ...
                                        <th class="td-id_universitas" > {{ __('universitas') }}</th>
