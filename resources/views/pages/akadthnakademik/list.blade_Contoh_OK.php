                                ...
                                <table class="table table-hover table-striped table-sm text-left">
                                    <thead class="table-header ">
                                        <tr>
                                            ...
                                            <th class="td-id_thn_akademik"> #</th>
                                        ...
                                        <tbody class="page-data">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td class="td-akaduniversitas_nama_universitas"><a size="sm" class="btn btn-sm btn btn-success page-modal" href="<?php print_link("akaduniversitas/view/$data[id_universitas]?subpage=1") ?>">
                                                            <i class="fa fa-info-circle"></i></a>
                                                        <?php echo  $data['akaduniversitas_nama_universitas']; ?>
                                                    </td>
                                                    <td class="td-semester_periode">
                                                        <a size="sm" class="btn btn-sm btn btn-success page-modal" href="<?php print_link("akadthnakademik/view/$data[id_thn_akademik]?subpage=1") ?>">
                                                            <i class="fa fa-info-circle"></i></a>
