...
<?php
    ...
    $can_add = $user->canAccess("akadprodi/add");
    $can_edit = $user->canAccess("akadprodi/edit");
    $can_view = $user->canAccess("akadprodi/view");
    $can_delete = $user->canAccess("akadprodi/delete");
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container-fluid">
            <div class="row justify-content-between align-items-center gap-3">
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">{{ __('akadProdi') }}</div>
                    </div>
                </div>
                <div class="col-auto  " >
                    <?php if($can_add){ ?>
                            ...
                            <table class="table table-hover table-striped table-sm text-left">
                                <thead class="table-header ">
                                    <tr>
                                        ...
                                        <?php Html :: get_field_order_link('fakultas_id', __('fakultas'), ''); ?>
                                        </th>
                                        ...
                                        <th class="td-nama_prodi" > {{ __('prodi') }}</th>
                                        <th class="td-btn"></th>
                                    </tr>
                                </thead>
                                <?php
                                ...
                                <tbody class="page-data">
                                    ...
                                    <tr>
                                        ...
                                        <td class=" td-checkbox">
                                            <label class="form-check-label">
                                            <input class="optioncheck form-check-input" name="optioncheck[]" value="<?php echo $data['id_prodi'] ?>" type="checkbox" />
                                            </label>
                                        </td>
                                        <?php } ?>
                                        <!--PageComponentStart-->
                                    ...
                                    <td class="td-akadfakultas_kode_fakultas">
                                        <?php echo  $data['akadfakultas_kode_fakultas'] ; ?>
                                    </td>
                                    <td class="td-akadfakultas_nama_fakultas">
                                        <?php echo  $data['akadfakultas_nama_fakultas'] ; ?>
                                    </td>
                                    <td class="td-kode_prodi">
                                        <?php echo  $data['kode_prodi'] ; ?>
                                    </td>
        ...
        <div class=" mt-3">
            <div class="row align-items-center justify-content-between">    
                <div class="col-md-auto d-flex">    
                    <?php if($can_delete){ ?>
                    <button data-prompt-msg="{{ __('promptDeleteRecords') }}" data-display-style="modal" data-url="<?php print_link("akadprodi/delete/{sel_ids}"); ?>" class="btn btn-sm btn-danger btn-delete-selected d-none">
