...
<?php
    ...
    $pageTitle = __('rpsPembahasanRps'); //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container-fluid">
            <div class="row justify-content-between align-items-center gap-3">
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">{{ __('rpsPembahasanRps') }}</div>
                    </div>
                </div>
                <div class="col-auto  " >
                    <?php if($can_add){ ?>
        ...
        <div class="row ">
            <div class="col comp-grid " >
                <div  class=" page-content" >
                    <div id="rpspembahasanrps-list-records">
                        <div id="page-main-content" class="table-responsive">
                            ...
                            <?php Html::page_bread_crumb("/rpspembahasanrps/", $field_name, $field_value); ?>
                            ...
                            <table class="table table-hover table-striped table-sm text-left">
                                <thead class="table-header ">
                                    <tr>
                                        ...
                                        <th class="td-pokok_bahasan" > {{ __('pokokBahasan') }}</th>
