...
<?php
    $pageTitle = __('editRpsPembahasanRp'); //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">{{ __('editRpsPembahasanRp') }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("rpspembahasanrps/edit/$rec_id"); ?>" method="post">
                        <!--[form-content-start]-->
                        @csrf
                        <div>
                            ...
                            <div class="form-group ">
                                <div class="row">
                                    <div class="col-sm-4">
                                        <label class="control-label" for="pokok_bahasan">{{ __('pokokBahasan') }} </label>
                                    </div>
                                    <div class="col-sm-8">
                                        <div id="ctrl-pokok_bahasan-holder" class=" ">
                                            <textarea placeholder="{{ __('enterPokokBahasan') }}" id="ctrl-pokok_bahasan" data-field="pokok_bahasan"  rows="5" name="pokok_bahasan" class=" form-control"><?php  echo $data['pokok_bahasan']; ?></textarea>
