...
<?php
    $pageTitle = __('editRpsPustakaRp'); //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">{{ __('editRpsPustakaRp') }}</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("rpspustakarps/edit/$rec_id"); ?>" method="post">
                        <!--[form-content-start]-->
                        @csrf
                        <div>
                            ...
                            <div class="form-group ">
                                <div class="row">
                                    <div class="col-sm-4">
                                        <label class="control-label" for="no_urut">{{ __('noUrut') }} </label>
                                    </div>
                                    <div class="col-sm-8">
                                        <div id="ctrl-no_urut-holder" class=" ">
                                            <input id="ctrl-no_urut" data-field="no_urut"  value="<?php  echo $data['no_urut']; ?>" type="number" placeholder="{{ __('enterNoUrut') }}" step="any"  name="no_urut"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group ">
                                <div class="row">
                                    <div class="col-sm-4">
                                        <label class="control-label" for="pustaka">{{ __('pustaka') }} </label>
                                    </div>
                                    <div class="col-sm-8">
                                        <div id="ctrl-pustaka-holder" class=" ">
                                            <textarea placeholder="{{ __('enterPustaka') }}" id="ctrl-pustaka" data-field="pustaka"  rows="5" name="pustaka" class=" form-control"><?php  echo $data['pustaka']; ?></textarea>
                            ...
                            <div class="form-group ">
                                <div class="row">
                                    <div class="col-sm-4">
                                        <label class="control-label" for="jenis_pustaka">{{ __('jenisPustaka') }} </label>
                                    </div>
                                    <div class="col-sm-8">
                                        <div id="ctrl-jenis_pustaka-holder" class=" ">
                                            <select  id="ctrl-jenis_pustaka" data-field="jenis_pustaka" name="jenis_pustaka"  placeholder="{{ __('selectAValue') }}"    class="form-select" >
                                            <option value="">{{ __('selectAValue') }}</option>
                                            <?php
                                                $options = Menu::jenisPustaka();
                                                $field_value = $data['jenis_pustaka'];
                                                if(!empty($options)){
                                                foreach($options as $option){
                                                $value = $option['value'];
                                                $label = $option['label'];
