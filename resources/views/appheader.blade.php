            ...
            <ul class="navbar-nav ms-auto">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <a class="dropdown-item" href="<?php print_link('account') ?>"><i class="fa fa-user"></i> {{ __('myAccount') }}</a>
                        <a class="dropdown-item" href="<?php print_link('auth/logout') ?>"><i class="fa fa-sign-out"></i> {{ __('logout') }}</a>
                    </ul>
                </li>
            </ul>
        </div>
